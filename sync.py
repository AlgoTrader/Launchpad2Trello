...
TRELLO_BOARD = 'Partner Integration'
...
TRELLO_KEY = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
TRELLO_SECRET = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"

# Open in browser
# https://trello.com/1/authorize?key=XXX&name=Mirantisn&expiration=never&response_type=token&scope=read,write
# to get the token. token should be READ and WRITE and should NEVER expire
TRELLO_TOKEN = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
...
for task in tasks:
    ...
    elif task.status == 'New' and task.assignee:
